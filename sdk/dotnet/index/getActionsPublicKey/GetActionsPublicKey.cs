...
namespace Pulumi.GitHub.index/getActionsPublicKey
{
    public static class GetActionsPublicKey
    {
        ...
        public static Task<GetActionsPublicKeyResult> InvokeAsync(GetActionsPublicKeyArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetActionsPublicKeyResult>("github:index/getactionspublickey/getActionsPublicKey:getActionsPublicKey", args ?? new GetActionsPublicKeyArgs(), options.WithVersion());
    }
