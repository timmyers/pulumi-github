...
namespace Pulumi.GitHub.index/getRelease
{
    public static class GetRelease
    {
        ...
        public static Task<GetReleaseResult> InvokeAsync(GetReleaseArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetReleaseResult>("github:index/getrelease/getRelease:getRelease", args ?? new GetReleaseArgs(), options.WithVersion());
    }
