...
namespace Pulumi.GitHub.index/getRepositories
{
    public static class GetRepositories
    {
        ...
        public static Task<GetRepositoriesResult> InvokeAsync(GetRepositoriesArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetRepositoriesResult>("github:index/getrepositories/getRepositories:getRepositories", args ?? new GetRepositoriesArgs(), options.WithVersion());
    }
