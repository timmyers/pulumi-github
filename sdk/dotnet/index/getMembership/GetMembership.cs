...
namespace Pulumi.GitHub.index/getMembership
{
    public static class GetMembership
    {
        ...
        public static Task<GetMembershipResult> InvokeAsync(GetMembershipArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetMembershipResult>("github:index/getmembership/getMembership:getMembership", args ?? new GetMembershipArgs(), options.WithVersion());
    }
