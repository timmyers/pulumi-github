...
__all__ = ['config', 'index/getactionspublickey', 'index/getipranges', 'index/getmembership', 'index/getrelease', 'index/getrepositories', 'index/getrepository', 'index/getteam', 'index/getuser']
for pkg in __all__:
    if pkg != 'config':
